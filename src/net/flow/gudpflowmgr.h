...
signals:
  ...
  void _flowCreated(const GFlow::UdpFlowKey* key, GFlow::Value* value);
  void _flowDeleted(const GFlow::UdpFlowKey* key, GFlow::Value* value);
};
