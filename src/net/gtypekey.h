...
typedef GTransportKey SnoopTcpKey;
typedef GTransportKey SnoopUdpKey;
...
typedef GTransportFlowKey SnoopTcpFlowKey;
typedef GTransportFlowKey SnoopUdpFlowKey;
...
typedef GTransportSessionKey SnoopTcpSessionKey;
typedef GTransportSessionKey SnoopUdpSessionKey;
